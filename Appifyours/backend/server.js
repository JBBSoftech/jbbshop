...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/jbbshop_app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '69bce8ec5212962084e97b13',
...
app.listen(PORT, () => {
  ...
  console.log(`jbbshop Backend Server running on port ${PORT}`);
